...
EXTRA_HEADERS = {
    ...
    'Referer': 'https://watchslipstream.com/browse',
    'Origin': 'https://watchslipstream.com'
}

GRAPHQL_URL = 'https://watchslipstream.com/graphql'
...
def get_categories():
    ...
    :rtype: list
    """
    response_data = myget(GRAPHQL_URL, get_graphql_query('BrowseQuery'), EXTRA_HEADERS)
